// Fecha objetivo: 19 de julio de 2025 a las 16:00 hrs
var fechaObjetivo = new Date("July 19, 2025 16:00:00").getTime();
...
function actualizarContador() {
    ...
    document.getElementById("dias").innerHTML = `<h2>${dias}</h2><p>Días</p>`;
    document.getElementById("horas").innerHTML = `<h2>${horas}</h2><p>Hrs</p>`;
    document.getElementById("minutos").innerHTML = `<h2>${minutos}</h2><p>Min</p>`;
    document.getElementById("segundos").innerHTML = `<h2>${segundos}</h2><p>Seg</p>`;

    // Si el contador ha llegado a 0, mostrar mensaje
    if (tiempoRestante < 0) {
        clearInterval(intervalo);
        document.getElementById("contador").innerHTML = "<h2>¡EN VIVO AHORA MISMO!</h2>";
    }
}
...
// Llamar inmediatamente para mostrar el contador
actualizarContador();
...
(function($) {
    ...
    $(window).on('load', function() {
        ...
        if (eventCounter.length) {
            eventCounter.countdown('2025/07/19', function(e) {
